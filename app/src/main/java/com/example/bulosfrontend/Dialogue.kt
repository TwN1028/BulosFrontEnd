...
object DialogueProvider {
    private val dialogues = mapOf(
        "english" to DialogueContent(
            ...
            R.string.go_back_eng, R.string.main_button_3_eng, "english",
        ),
        "filipino" to DialogueContent(
            ...
            R.string.go_back_fil, R.string.main_button_3_fil, "filipino",
        ),
        "bulos" to DialogueContent(
            ...
            R.string.go_back_bul, R.string.main_button_3_bul, "bulos",
        ),
    )
